...
export default function TrackEvent() {
  ...
  return (
    <>
      <NextSeo
        title="Willow Docs - Delete a user"
        description="API documentation for deleting a user"
      />

      <DocsContainer>
        <h1 className="mb-14 text-3xl font-medium">Deleting a user</h1>
        ...
        <div className="flex w-full flex-col justify-between space-y-4 lg:flex-row lg:space-y-0">
          <article className="w-full space-y-4 lg:w-5/12">
            <div>
              <p>
                Sometimes you need to delete a user. This is how to do it.
  ...
  return (
    <div className="mb-4 flex flex-col rounded-md border-2 border-zinc-600 bg-zinc-800 text-sm text-zinc-400">
      ...
      <div className="flex items-center py-2">
        ...
        <div className=" w-9/12 pl-4 text-left">USer deleted</div>
      </div>
