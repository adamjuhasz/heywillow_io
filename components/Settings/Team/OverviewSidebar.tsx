...
export default function OverviewTeamSidebar(): JSX.Element {
  ...
  return (
    <div className="flex w-56 shrink-0 flex-col space-y-4 text-sm font-light text-zinc-500">
      <SidebarLink exact href="/a/[namespace]/settings/self">
        Profile
      </SidebarLink>
      <SidebarLink href="/a/[namespace]/settings/self/invites">
        Invites{" "}
        {pendingCount !== 0 ? (
